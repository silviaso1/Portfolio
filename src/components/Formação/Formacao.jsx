...
export function Formacao(){
    ...
    <section className="Formacao">
      ...
      <h3 className="experiencia-subtitulo">Acadêmica</h3>
      ...
      <div class="mt-3" data-anime>
      <hr />
      </div>
      <h3 className="experiencia-subtitulo">Cursos complementares</h3>
      ...
      <div className="experiencia-item">
        ...
        <div className="experiencia-descricao">
          ...
          <p className="experiencia-ferramentas">Ferramentas:</p>
          <div className="experiencia-icons">
            <img src="path/to/vue-icon.png" alt="Python" />
          </div>
        </div>
      </div>
    </section>
